...
<body class="">
    ...
    <main class="main-content  mt-0 ">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://assets-a1.kompasiana.com/items/album/2022/06/07/whatsapp-image-2022-06-07-at-12-29-20-629ee60daa3ccd31ef600502.jpeg'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Halo Siswa WIKRAMA!</h1>
                        <p class="text-lead text-white"> Aplikasi</p>
                    </div>
                </div>
            </div>
        </div>
